...
&nbsp;
&nbsp;
## Github has various BASH and Python projects and a Splunk attack simulation
...
- Python and BASH scipts for automating scans and pulling reports from Nessus' API
